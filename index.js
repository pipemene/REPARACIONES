...
app.get('/api/impersonar', (req, res) => {
  ...
  const vista = ordenes.map(o => ({
    id: o.id, codigoInmueble: o.codigoInmueble, descripcion: o.descripcion,
    estado: o.estado, tecnicoId: o.tecnicoId, evidencias: o.evidencias?.length || 0, tieneFirma: !!o.firma
  }));
